...
TEST_F(MetricsTest, coordinator_metric_desc_test)
{
    ...
    static const struct {
        ...
        { metrics::KvMetricId::COORDINATOR_RPC_EXCHANGE_BOOTSTRAP_OBSERVATION_REQUEST_TOTAL,
          "coordinator_rpc_exchange_bootstrap_observation_request_total", metrics::MetricType::COUNTER, "count" },
