...
METRICS = {
    ...
    'bthread_keytable_count': ('Keytables retained', '', 'bthread'),
    'bthread_count': ('Live bthreads', '', 'bthread'),
    'bthread_worker_count': ('Scheduler workers', '', 'bthread'),
    'bthread_keytable_memory': ('Keytable structures', ' bytes', 'keytable_memory'),
    'bthread_worker_usage': ('Worker usage', ' workers', 'bthread_usage'),
    'brpc_active_requests': ('Active RPC requests', '', 'rpc'),
    'bthread_local_runqueue_count': ('Local runnable queues', '', 'rpc'),
    'brpc_stats_available': ('BRPC stats available', '', 'brpc_status'),
    'brpc_stats_read_failures': ('BRPC read failures', '', 'brpc_status'),
...
CHARTS = {
    ...
    'bthread': 'Bthread and keytable counts',
    'keytable_memory': 'Keytable structure memory',
    'bthread_usage': 'Scheduler worker usage',
    'rpc': 'Active RPCs and local runnable queues',
    'brpc_status': 'BRPC collection status',
