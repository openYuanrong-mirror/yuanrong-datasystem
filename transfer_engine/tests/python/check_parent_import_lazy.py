...
fake_transfer_engine.MemoryRegistration = object()
sys.modules["yr.datasystem._transfer_engine"] = fake_transfer_engine

from yr.datasystem import MemoryRegistration, TransferEngine  # noqa: E402
...
if MemoryRegistration is not fake_transfer_engine.MemoryRegistration:
    raise RuntimeError("MemoryRegistration was not loaded from the optional transfer-engine module")
