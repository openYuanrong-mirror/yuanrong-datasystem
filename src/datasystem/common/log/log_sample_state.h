 ...
 * trace attachment state byte. ApplyLogSampleState() restores that decision
 ...
 * datasystem/protos/log_sample.proto, so this log module header depends on
 * log_sample_cc_proto only.
 */
