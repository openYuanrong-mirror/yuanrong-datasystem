...
constexpr MetricDesc KV_METRIC_DESCS[] = {
    ...
    { 46, "shm_unit_created_total", MetricType::COUNTER, "count" },
    { 47, "shm_unit_destroyed_total", MetricType::COUNTER, "count" },
    ...
    { 108, "shm_fresh_extent_oom_total", MetricType::COUNTER, "count" },
    { 109, "shm_reusable_extent_oom_total", MetricType::COUNTER, "count" },
    ...
    { 116, "brpc_rpc_e2e_fail_latency", MetricType::HISTOGRAM, "us" },
    { 117, "brpc_rpc_network_residual_fail_latency", MetricType::HISTOGRAM, "us" },
    { 118, "coordinator_rpc_put_request_total", MetricType::COUNTER, "count" },
    { 119, "coordinator_rpc_range_request_total", MetricType::COUNTER, "count" },
    { 120, "coordinator_rpc_delete_range_request_total", MetricType::COUNTER, "count" },
    { 121, "coordinator_rpc_watch_range_request_total", MetricType::COUNTER, "count" },
    { 122, "coordinator_rpc_cancel_watch_request_total", MetricType::COUNTER, "count" },
    { 123, "coordinator_rpc_keep_alive_request_total", MetricType::COUNTER, "count" },
    ...
    { 131, "coordinator_watch_notification_sent_events_total", MetricType::COUNTER, "count" },
    { 132, "coordinator_watch_notification_sent_bytes_total", MetricType::COUNTER, "bytes" },
    { 133, "coordinator_watch_rpc_latency", MetricType::HISTOGRAM, "us" },
    { 134, "coordinator_watch_rpc_failure_total", MetricType::COUNTER, "count" },
    { 135, "coordinator_watch_channels", MetricType::GAUGE, "count" },
    { 136, "coordinator_watch_fan_out_events_total", MetricType::COUNTER, "count" },
    { 137, "coordinator_watch_notification_inflight_requests", MetricType::GAUGE, "count" },
