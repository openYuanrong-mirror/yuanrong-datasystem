...
enum class KvMetricId : uint16_t {
    ...
    WORKER_TO_CLIENT_GET_TCP_TOTAL_BYTES = 20,
    ...
    WORKER_FROM_CLIENT_PUBLISH_SHM_TOTAL_BYTES = 88,
    WORKER_FROM_CLIENT_PUBLISH_LOCAL_TOTAL_BYTES = 89,
    WORKER_FROM_CLIENT_PUBLISH_TCP_TOTAL_BYTES = 90,
    WORKER_FROM_CLIENT_PUBLISH_URMA_TOTAL_BYTES = 91,
    ...
    COORDINATOR_RPC_EXCHANGE_BOOTSTRAP_OBSERVATION_REQUEST_TOTAL = 127,
    ...
    // Worker -> client Get path bytes split by transport medium.
