...
public:
     ...
     * @param[in] shutdownRequester Non-blocking callback that wakes the owning process lifecycle. Configure before Init.
     */
...
private:
    ...
    void RestoreScaleInPreparation(const cluster::TopologySnapshot &snapshot);
